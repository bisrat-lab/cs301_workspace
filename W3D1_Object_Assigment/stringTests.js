...
describe("checkSpam", function () {
    ...
    it("does not contain prize or lottery", function () {
        ...
        const string2 = "there is a no winner";
...
describe("titleCase", function () {
    ...
    it("The first latter capitalized", function(){
        const string2 = "javascript";
        assert.strictEqual(str.titleCase(string2), "Javascript");
    }
    );
...
describe("getAverageAge", function () {
    ...
    it("15 (average of 10 and 20)", function () {

        const input = [{name:"abc", age:20},
        {name:"xyz", age:10}];

        assert.strictEqual(str.getAverageAge(input), 15);

    });

    it("50 (average of 60 and 40)", function () {

        const input = [{name:"def", age:60},
        {name:"dad", age: 40}];

        assert.strictEqual(str.getAverageAge(input), 50);
